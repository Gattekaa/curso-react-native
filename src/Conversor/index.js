...
import { CURRENCY_CONVERTER_API_KEY } from 'react-native-dotenv';
...
class Conversor extends Component{
  ...
  async converter(){
    ...
    const response = await api.get(`convert?q=${de_para}&compact=ultra&apiKey=${CURRENCY_CONVERTER_API_KEY}`);
